  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-medium text-foreground">Cellar not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          That bottle isn't on the list. Let's pour you another.
        </p>
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-xl bg-merlot px-5 py-3 text-sm font-medium text-primary-foreground transition hover:bg-merlot/90"
          >
            Return home
          </Link>
        </div>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-serif text-2xl text-foreground">A cork broke off in the bottle.</h1>
